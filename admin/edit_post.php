...
<option value='<?php echo $post_status ?>'><?php echo $post_status; ?></option>
    ...
    echo "<option value='Published'>Published</option>";
     ...
     <div class="form-group">
       <img width="85" src="includes/images/<?php echo $post_image;?>" alt="Realated to <?php echo"$post_title";?>">
         <label for="post_image">Change Image</label> <input  type="file"  name="image">
      </div>
